...
const PlaylistPublic = () => {
  ...
  return (
   <PublicLayout>
     <article className="top-24  grid gap-1
        ...
        <div className={`relative cassette ${isShowFront ? "front" : "back"} `} >
            ...
            <div className="front">
                ...
                absolute top-[15px] left-[20px] gap-1 text-sm">
                   ...
                   <h3  className="bg-transparent flex-1 
                ...
                type="button"
                className="absolute bottom-4 right-[20px] p-[3px]">
                  <ShareIcon/>
                </button>

                <button  className="absolute bottom-4 right-[50px] p-[3px]">
            ...
            <div className="absolute top-0 back">
             ...
             <div className="bg-white flex p-1 items-center rounded-md w-[198px]
                absolute top-[15px] left-[20px] gap-1 text-sm">
                      ...
                      flex-1 outline-none text-black" >{playlist?.to}</span>
                    
                </div>
                <div className="bg-white p-1 rounded-md w-[198px]
                absolute top-[50px] left-[20px] gap-1 text-sm text-black h-[100px]
                overflow-y-auto">
