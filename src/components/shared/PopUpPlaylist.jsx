...
const PopUpPlaylist = ({isShowPlaylist} ) => {
    ...
    const handleSubmit = (e) => {
        ...
        .then(() => {
            ...
            alert("Playlist creada corresctamente");
        })
  ...
  return (
    ...
    className={`fixed z-20 top-24 bg-primary-light uppercase grid p-4 gap-1
    rounded-md text-start font-semibold border
     border-secondary ${isShowPlaylist ? "right-10" : "-right-full"} 
     transition-all`}>
        ...
        <section className="normal-case font-normal w-[238px] max-h-[170px]
        overflow-y-auto">
        ...
        type="submit"
         className="border-2 border-white uppercase p-2 px-4 rounded-full
        max-w-max mx-auto hover:text-secondary hover:border-secondary
        transitions-colors">Crear</button>
    </form>
  )
}
